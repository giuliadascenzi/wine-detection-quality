...
def print_graphs_Polinomial_SVM_Cs(DTR, LTR, k ):
    ...
    def oneGraphSingleFold(data, prior, cost_fn, cost_fp, pi_T):
        ...
        for i in range (Cs.size):
            C= Cs[i]
            minDCFs[i],_ = model_validation.singleFold_DCF(data, LTR, SVMClassifier.Polinomial_SVM_computeLogLikelihoods, prior , cost_fn, cost_fp, [pi_T, C])
    ...
    def oneGraphKFold(data, prior, cost_fn, cost_fp, pi_T):
        ...
        for i in range (Cs.size):
            C= Cs[i]
            minDCFs[i],_,_ = model_validation.k_cross_DCF(data, LTR,k, SVMClassifier.Polinomial_SVM_computeLogLikelihoods, prior , cost_fn, cost_fp, [pi_T, C])
